...
@Component({
  selector: 'app-plans-sidebar-info',
  templateUrl: './plans-sidebar.component.html',
  styleUrls: ['./plans-sidebar.component.scss'],
})
export class PlansSidebarComponent implements OnInit {
